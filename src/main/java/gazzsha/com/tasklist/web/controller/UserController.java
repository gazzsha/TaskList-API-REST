...
public class UserController {
    ...
    @PreAuthorize(value = "@customSecurityExpression.canAccessUser(#id)")
    public List<TaskDto> getTasksByUserId(@PathVariable(name = "id") Long id) {
        List<Task> tasks = taskService.getAllByUseId(id);
    ...
    @PreAuthorize(value = "@customSecurityExpression.canAccessUser(#id)")
    public TaskDto createTask(@PathVariable(name = "id") Long id, @Validated(OnCreate.class) @RequestBody TaskDto dto) {
